...
- 《[P2P技术详解(一)：NAT详解——详细原理、P2P简介](http://www.52im.net/thread-50-1-1.html)》（本文）
...
![P2P技术详解(一)：NAT详解——详细原理、P2P简介_图1 IPv4网络地址划分](imgs/200926crr724j68tledk1p.png)
...
![P2P技术详解(一)：NAT详解——详细原理、P2P简介_2.png](imgs/120101a6g22aqw64mndrg6.png)
...
![P2P技术详解(一)：NAT详解——详细原理、P2P简介_3.png](imgs/120111pw4bdv7p35zwo7xr.png)
...
![P2P技术详解(一)：NAT详解——详细原理、P2P简介_图4 NAT对端到端通信模型的破坏](imgs/203015ak3kk90kyh4c8484.png)
...
![P2P技术详解(一)：NAT详解——详细原理、P2P简介_5.png](imgs/120124caawy3awya135eh3.png)

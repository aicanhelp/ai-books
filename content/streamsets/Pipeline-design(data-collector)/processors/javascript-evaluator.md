...
![img](https://streamsets.com/documentation/controlhub/latest/help/reusable-content/shared-graphics/icon-Edge.png)在Data Collector Edge管道中， JavaScript Evaluator脚本不能包含`sdc`或 `sdcFunctions`对象。
